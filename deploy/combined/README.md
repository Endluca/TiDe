...
`20260814_61_teacher_copy`、教师端 `0041_crm_sso_hybrid` 和唯一当前
...
release public 57 → teacher 0040 → teacher 0041 → public 59 → public 60 → public 61 执行；
完整链和数据库契约探针未通过前禁止上线。**
...
9. 确认 public 54 / teacher 0037 同时就绪且当前 G04 已不再返回设备步骤后，严格按
   ...
   `20260813_60_dom_privacy`，再应用 `20260814_61_teacher_copy`。不得在 teacher 0037 之前执行
   public 55；最终契约探针只接受 public 61 / teacher 0041。
