const notificationCopy = {
  GROWTH_STAGE_AVAILABLE: {
    ...
    body: {
      en: "A new set of required tasks is now available in your growth path. Work through them in the order that works best for you.",
      zh: "一组新的必修任务已经开放，你可以按照适合自己的顺序完成本阶段任务。",
    },
  },
  PERSONALIZED_TASK_ASSIGNED: {
    body: {
      en: "A new improvement task is ready for you. Open it when you’re ready to take the next step.",
      zh: "一项新的改善任务已准备好，你可以在合适的时候打开并开始下一步。",
    },
  },
  PERSONALIZED_TASK_DUE_24H: {
    body: {
      en: "A quick reminder: this improvement task is due within 24 hours. You can pick up where you left off.",
  ...
  TASK_RETRY_REQUIRED: {
    title: {
      en: "Please try the task again.",
      zh: "任务需要再次尝试",
    },
    body: {
      en: "Open the task, review the feedback, and try again.",
      zh: "请打开任务查看反馈后再次尝试。",
    },
  },
  TASK_REVIEW_PENDING: {
    ...
    body: {
      en: "Your task submission is saved and still under review. Open the task to check the latest status.",
