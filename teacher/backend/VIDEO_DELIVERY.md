...
当前需要视频／测试的任务已统一改为阔知 iframe，`config/public-videos-v2.json` 的活动视频清单为空。G02 已改为 TIDE 原生政策文档，不再属于视频任务。以下脚本仅保留为历史运维能力或未来非阔知媒体场景使用，当前任务发布流程不得用它恢复 G05–G09 的本地视频。
