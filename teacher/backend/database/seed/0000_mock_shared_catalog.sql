...
SELECT
    ...
    'INBOUND_STATUS_ONLY'
FROM (VALUES
    ('G01:v1', 'G01', 'PUBLISHED', 'Profile & Credentials Completion', 'Complete the required profile statuses and TESOL learning evidence.', 'Confirm Self-intro and TESOL, pass all 61 questions, complete the Essay and submit the completion proof.', 'Self-intro and TESOL are complete, the 61-question check reaches 80%, the Essay is complete and the completion proof is submitted.', 'Your profile and required TESOL learning evidence are complete.', 'P1', 3, 'FOUNDATION', 1, 'MANDATORY_GROWTH', 'READY'),
    ...
    ('G03:v1', 'G02', 'PUBLISHED', 'Platform Policies', 'Learn the essential classroom and account-safety rules.', 'Read the in-platform policy guide and complete its quiz.', 'The policy guide is confirmed and the quiz requirements pass.', 'You can apply the core platform policies in class.', 'P1', 2, 'FOUNDATION', 2, 'MANDATORY_GROWTH', 'READY'),
    ...
    ('G06:v1', 'G05', 'PUBLISHED', 'TTP Orientation', 'Understand TTP and its key business scenarios.', 'Watch the in-platform TTP video and confirm every item in the learning checklist.', 'The TTP video is watched in full and every published checklist item is confirmed.', 'You understand the key TTP workflow and commitments.', 'P2', 3, 'INTEGRATION', 5, 'MANDATORY_GROWTH', 'READY'),
    ...
    ('G09:v1', 'G08', 'PUBLISHED', 'Cocos Course Training', 'Learn the core Cocos teaching flow.', 'Complete the configured in-platform videos and quiz.', 'All configured videos and quiz requirements pass.', 'You can prepare for a Cocos class.', 'P2', 5, 'ADVANCE', 8, 'MANDATORY_GROWTH', 'READY'),
    ('G10:v1', 'G09', 'PUBLISHED', 'SET Teaching Fundamentals', 'Learn the fundamentals of SET teaching.', 'Watch the in-platform Mock video slot and complete the five-question Mock check.', 'The Mock video is watched in full and the five-question check reaches 80%.', 'You understand the SET teaching foundation.', 'P2', 5, 'ADVANCE', 9, 'MANDATORY_GROWTH', 'READY')
) AS catalog(
