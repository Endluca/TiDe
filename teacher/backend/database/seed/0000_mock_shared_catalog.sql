...
SELECT
    ...
    'INBOUND_STATUS_ONLY'
FROM (VALUES
    ('G01:v1', 'G01', 'PUBLISHED', 'Profile & Credentials Completion', 'Complete the required TESOL status and learning evidence.', 'Confirm TESOL, pass all 61 questions, complete the Essay and submit the completion proof.', 'TESOL is complete, the 61-question check reaches 80%, the Essay is complete and the completion proof is submitted.', 'Your profile and required TESOL learning evidence are complete.', 'P1', 3, 'FOUNDATION', 1, 'MANDATORY_GROWTH', 'READY'),
