...
FROM (VALUES
    ...
    ('G09:v1', 'G08', 'PUBLISHED', 'Global Communicator Training', 'Learn the core Global Communicator teaching flow.', 'Complete the configured in-platform videos and quiz.', 'All configured videos and quiz requirements pass.', 'You can now confidently prepare for a Global Communicator lesson.', 'P2', 5, 'ADVANCE', 8, 'MANDATORY_GROWTH', 'READY'),
