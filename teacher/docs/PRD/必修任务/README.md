...
| `free-trial-training` | Free Trial Training 体验课培训 | Domestic pending，不计入当前 9 项必修 | [候选任务 PRD](TASK-free-trial-training_体验课培训.md) | 保留已有章节、题库和素材作为候选资料；业务确认前不展示、不计数、不计分 |
