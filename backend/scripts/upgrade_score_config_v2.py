...
from app.config_models import SCORE_POLICY_V2_PAYLOAD, ConfigKey, ScoreGraduationConfig
...
def upgrade_score_config_v2(
    *,
    service: ConfigService | None = None,
    app_env: str | None = None,
    creator_actor_id: str = "system:score-v2-upgrade-creator",
    publisher_actor_id: str = "system:score-v2-upgrade-publisher",
) -> dict:
    """Publish the locked v2 score policy once in a local development database."""
...
def main() -> int:
    try:
        result = upgrade_score_config_v2()
