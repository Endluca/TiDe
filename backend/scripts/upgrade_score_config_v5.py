...
from app.config_models import SCORE_POLICY_V5_PAYLOAD, ConfigKey, ScoreGraduationConfig
...
def upgrade_score_config_v5(
    *,
    service: ConfigService | None = None,
    app_env: str | None = None,
    creator_actor_id: str = "system:score-v5-upgrade-creator",
    publisher_actor_id: str = "system:score-v5-upgrade-publisher",
) -> dict:
    """Publish the current perfect-count and three-gate score policy."""
...
def main() -> int:
    try:
        result = upgrade_score_config_v5()
