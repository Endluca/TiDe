...
from app.config_models import SCORE_POLICY_V3_PAYLOAD, ConfigKey, ScoreGraduationConfig
...
def upgrade_score_config_v3(
    *,
    service: ConfigService | None = None,
    app_env: str | None = None,
    creator_actor_id: str = "system:score-v3-upgrade-creator",
    publisher_actor_id: str = "system:score-v3-upgrade-publisher",
) -> dict:
    """Publish the locked 2026-07-20 v3 policy without rewriting v2 history."""
...
def main() -> int:
    try:
        result = upgrade_score_config_v3()
