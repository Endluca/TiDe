...
from app.config_models import SCORE_POLICY_V4_PAYLOAD, ConfigKey, ScoreGraduationConfig
...
def upgrade_score_config_v4(
    *,
    service: ConfigService | None = None,
    app_env: str | None = None,
    creator_actor_id: str = "system:score-v4-upgrade-creator",
    publisher_actor_id: str = "system:score-v4-upgrade-publisher",
) -> dict:
    """Publish v4 without rewriting the frozen v2/v3 configuration history."""
...
def main() -> int:
    try:
        result = upgrade_score_config_v4()
