...
from app.config_models import SCORE_POLICY_V7_PAYLOAD, ConfigKey, ScoreGraduationConfig
...
def upgrade_score_config_v7(
    *,
    service: ConfigService | None = None,
    app_env: str | None = None,
    creator_actor_id: str = "system:score-v7-upgrade-creator",
    publisher_actor_id: str = "system:score-v7-upgrade-publisher",
) -> dict:
    """Publish the 2-point perfect-completion policy without rewriting v6 history."""
...
def main() -> int:
    try:
        result = upgrade_score_config_v7()
