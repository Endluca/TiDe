...
def test_full_plan_preserves_every_cross_schema_switch_point() -> None:
    ...
    assert [(action.schema, action.target) for action in plan] == [
        ...
        ("public", upgrade.PUBLIC_59),
        ("public", upgrade.PUBLIC_60),
        ("public", upgrade.PUBLIC_61),
        ("public", upgrade.PUBLIC_62),
        ("public", upgrade.PUBLIC_63),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            upgrade.DatabaseState(upgrade.PUBLIC_63, upgrade.TEACHER_41),
            upgrade.PUBLIC_64,
        ),
        (
            upgrade.DatabaseState(upgrade.PUBLIC_64, upgrade.TEACHER_41),
            upgrade.PUBLIC_65,
        ),
        (
