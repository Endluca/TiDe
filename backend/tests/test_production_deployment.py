...
def test_readme_runs_preflight_before_migration() -> None:
    ...
    assert "20260824_101_dts_single_pipeline_reset" in readme
    assert "0041_crm_sso_hybrid" in readme
    assert "0043_p_rel_execution_catalog" in readme
    ...
    assert (
        ...
        "release public 57 → teacher 0040 → teacher 0041 → public 59–65 → "
        "teacher 0042 → public 66–99 → teacher 0043 → public 100–101"
    ) in readme
